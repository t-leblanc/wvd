...
Test-AzResourceGroupDeployment -ResourceGroupName "wergadds" -TemplateFile ".\Infra-As-Code\HybridAD\deploy.json" -TemplateParameterFile ".\Infra-As-Code\HybridAD\Parameters\parameters.json" -Verbose
New-AzResourceGroupDeployment -ResourceGroupName "wergadds" -TemplateFile ".\Infra-As-Code\HybridAD\deploy.json" -TemplateParameterFile ".\Infra-As-Code\HybridAD\Parameters\parameters.json" -Verbose
